                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                           ...
                           // echo "<td>{$row['projectName']}</td>";
                            ...
                            echo '<td><a href="other_schedule.php?projectID='.$row['projectID'].'" >View</a></td>';
                            echo '<td><a href="other_location.php?projectID='.$row['projectID'].'" >View</a></td>';
                           

                            echo "</tr>";
                        }
                    } else {
                        echo "<tr><td colspan='8'>No data available for ID $searchId in the Other Sector.</td></tr>";
                    }
                } else {
