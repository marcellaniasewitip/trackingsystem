    ...
    <div class="main">
      <table class="table table-hover table-warning text-center table-bordered">
        ...
        <tbody> 
              ...
              if ($result) {
                  ...
                  if (mysqli_num_rows($result) > 0) {
                      while ($row = mysqli_fetch_assoc($result)) {
                          ...
                          echo '<td><a href="agri_schedule.php?projectID='.$row['projectID'].'" class="btn btn-primary">View</a></td>';
                          echo '<td><a href="agri_location.php?projectID='.$row['projectID'].'" class="btn btn-primary">View</a></td>';
                          echo "</tr>";
                      }
                  } else {
                      echo "<tr><td colspan='6' rowspan='3'>No data available for ID $searchId in the Agricultural Sector.</td></tr>";
                  }
              } else {
          ...
          <br><br>
          <a href="../admin/project/html/project_update.php" class="btn btn-danger mb-3">Exit</a> 
        </tbody>
      </table>
    </div>
