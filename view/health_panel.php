              ...
              if ($result) {
                  ...
                  if (mysqli_num_rows($result) > 0) {
                      while ($row = mysqli_fetch_assoc($result)) {
                          ...
                          echo '<td><a href="health_schedule.php?projectID='.$row['projectID'].'" class="btn btn-primary">View</a></td>';
                          echo '<td><a href="health_location.php?projectID='.$row['projectID'].'" class="btn btn-primary">View</a></td>';
                          echo "</tr>";
                      }
                  } else {
                      echo "<tr><td colspan='6'>No data available for ID $searchId in the Health Sector.</td></tr>";
                  }
              } else {
